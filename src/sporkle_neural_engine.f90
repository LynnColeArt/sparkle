module sporkle_neural_engine
  ...
  type :: neural_engine_context
    ...
    integer :: num_cores = 0
    real(dp) :: tops = 0.0  ! Tera-operations per second
    
    ! Performance counters
    integer :: operations_dispatched = 0
    real(dp) :: total_compute_time = 0.0
  end type
...
contains
  ...
  subroutine gemm_on_ane(ctx, a, b, c, m, n, k)
    ...
    real(sp), target, intent(out) :: c(m, n)
...
end module sporkle_neural_engine