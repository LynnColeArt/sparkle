module sporkle_parallel_kernels
  ! Parallel implementations of core kernels
  ! The Sporkle Way: Use all the cores, respect the system
...
end module sporkle_parallel_kernels