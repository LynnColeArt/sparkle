module sparkle_gpu_backend_detect
  ! Enhanced GPU backend detection
  ! The Sparkle Way: Know what you're working with!
...
contains
  ...
  function detect_opengl_version() result(info)
    ...
    glxinfo_path = "/tmp/sparkle_glxinfo.txt"
...
end module sparkle_gpu_backend_detect