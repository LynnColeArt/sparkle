module sparkle_apple_orchestrator
  ! The REAL Sparkle vision: Use EVERYTHING on the chip!
  ...
  type :: heterogeneous_operation
    ...
    integer(int64) :: flops = 0
    integer(int64) :: memory_bytes = 0
    
    ! Profiling data for routing decisions
    real(real64) :: cpu_time = 0.0
    real(real64) :: gpu_time = 0.0
    real(real64) :: ane_time = 0.0
    real(real64) :: amx_time = 0.0
  ...
  type :: apple_orchestrator
    ...
    real(real64) :: total_tflops = 0.0
    real(real64) :: total_bandwidth = 0.0
    integer(int64) :: unified_memory_size = 0
...
end module sparkle_apple_orchestrator
