module sparkle_gpu_benchmark
  ...
  type :: kernel_profile
    real(real64) :: time_ms = 0.0
    real(real64) :: gflops = 0.0
    real(real64) :: bandwidth_gb_s = 0.0
    real(real64) :: arithmetic_intensity = 0.0
...
contains
  ...
  function gpu_benchmark_param_methods(kernel, work_size, params) result(best_method)
    ...
    real(real64) :: time_uniform, time_buffer, time_inline
    real(real64) :: best_time
  ...
  function profile_kernel(kernel, work_size, params) result(profile)
    ...
    real(real64) :: test_time, best_time
...
end module sparkle_gpu_benchmark