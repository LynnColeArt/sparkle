module sparkle_rdna3_shaders
  ...
  integer(int32), parameter :: S_ENDPGM        = int(z'BF810000', int32)  ! End program
  integer(int32), parameter :: S_NOP           = int(z'BF800000', int32)  ! No operation
  integer(int32), parameter :: S_WAITCNT       = int(z'BF8C0000', int32)  ! Wait for count
  
  ! SOP2 instructions (scalar ops with 2 operands)
  integer(int32), parameter :: S_ADD_U32       = int(z'80000000', int32)  ! s_add_u32
  integer(int32), parameter :: S_MUL_I32       = int(z'82000000', int32)  ! s_mul_i32
  
  ! VOP3 instructions (vector ops)
  integer(int32), parameter :: V_ADD_F32       = int(z'D5030000', int32)  ! v_add_f32
  integer(int32), parameter :: V_MUL_F32       = int(z'D5080000', int32)  ! v_mul_f32
  integer(int32), parameter :: V_FMA_F32       = int(z'D52B0000', int32)  ! v_fma_f32
  
  ! Memory instructions
  integer(int32), parameter :: BUFFER_LOAD_F32 = int(z'E0300000', int32)  ! buffer_load_format_x
  integer(int32), parameter :: BUFFER_STORE_F32= int(z'E0700000', int32)  ! buffer_store_format_x
  
  ! Shader code type
  type, public :: shader_code
    integer(int32), allocatable :: code(:)
    integer :: size_dwords
...
end module sparkle_rdna3_shaders