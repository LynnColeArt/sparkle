module sparkle_compute_shader
  ...
  type :: shader_compiler
    ! Translates Sparkle kernels to GLSL compute shaders
  contains
...
contains
  ...
  ! Translate a Sparkle kernel to GLSL compute shader
  ...
  subroutine shader_dispatch(this, global_size)
    ...
    integer(int64), intent(in) :: global_size(3)
...
end module sparkle_compute_shader