module sparkle_pm4_packets
  ...
  integer(int32), parameter :: PACKET_TYPE0 = 0  ! Register writes
  integer(int32), parameter :: PACKET_TYPE1 = 1  ! Deprecated
  integer(int32), parameter :: PACKET_TYPE2 = 2  ! Deprecated  
  integer(int32), parameter :: PACKET_TYPE3 = 3  ! Most commands
  
  ! Common PM4 opcodes
  integer(int32), parameter :: IT_NOP                = int(z'10')
  integer(int32), parameter :: IT_SET_CONTEXT_REG    = int(z'28')
  integer(int32), parameter :: IT_SET_CONFIG_REG     = int(z'2C')
  integer(int32), parameter :: IT_SET_SH_REG         = int(z'2F')
  integer(int32), parameter :: IT_SET_UCONFIG_REG    = int(z'79')
  integer(int32), parameter :: IT_WAIT_REG_MEM       = int(z'46')
  integer(int32), parameter :: IT_WRITE_DATA         = int(z'6A')
  integer(int32), parameter :: IT_ACQUIRE_MEM        = int(z'82')
  integer(int32), parameter :: IT_DISPATCH_DIRECT    = int(z'7D')
  
  ! Register base addresses
  integer(int32), parameter :: SI_CONTEXT_REG_OFFSET = int(z'00028000')
  integer(int32), parameter :: SI_CONFIG_REG_OFFSET  = int(z'00008000')
  integer(int32), parameter :: SI_SH_REG_OFFSET      = int(z'00002C00')
  integer(int32), parameter :: SI_UCONFIG_REG_OFFSET = int(z'00030000')
  
  ! Compute shader registers
  integer(int32), parameter :: COMPUTE_PGM_LO        = int(z'2E12')  ! Lower 32 bits of shader address
  integer(int32), parameter :: COMPUTE_PGM_HI        = int(z'2E13')  ! Upper 32 bits of shader address
  integer(int32), parameter :: COMPUTE_PGM_RSRC1     = int(z'2E14')  ! Resource descriptor 1
  integer(int32), parameter :: COMPUTE_PGM_RSRC2     = int(z'2E15')  ! Resource descriptor 2
  integer(int32), parameter :: COMPUTE_NUM_THREAD_X  = int(z'2E19')  ! Threads per group X
  integer(int32), parameter :: COMPUTE_NUM_THREAD_Y  = int(z'2E1A')  ! Threads per group Y
  integer(int32), parameter :: COMPUTE_NUM_THREAD_Z  = int(z'2E1B')  ! Threads per group Z
  integer(int32), parameter :: COMPUTE_DIM_X         = int(z'2E23')  ! Grid size X
  integer(int32), parameter :: COMPUTE_DIM_Y         = int(z'2E24')  ! Grid size Y
  integer(int32), parameter :: COMPUTE_DIM_Z         = int(z'2E25')  ! Grid size Z
  integer(int32), parameter :: COMPUTE_START_X       = int(z'2E26')  ! Start offset X
  integer(int32), parameter :: COMPUTE_START_Y       = int(z'2E27')  ! Start offset Y
  integer(int32), parameter :: COMPUTE_START_Z       = int(z'2E28')  ! Start offset Z
  integer(int32), parameter :: COMPUTE_USER_DATA_0   = int(z'2E40')  ! User data registers (16 total)
...
contains
  ...
  subroutine pm4_builder_ensure_space(this, n)
    ...
    integer(int32), allocatable :: new_buffer(:)
  ...
  subroutine pm4_set_sh_reg(builder, reg_offset, values)
    type(pm4_packet_builder), intent(inout) :: builder
    integer(int32), intent(in) :: reg_offset
  ...
  subroutine pm4_wait_reg_mem(builder, reg_addr, value, mask)
    type(pm4_packet_builder), intent(inout) :: builder
    integer(int64), intent(in) :: reg_addr
    integer(int32), intent(in) :: value, mask
  ...
  subroutine pm4_write_data(builder, dst_addr, data)
    type(pm4_packet_builder), intent(inout) :: builder
    integer(int64), intent(in) :: dst_addr
  ...
  subroutine pm4_build_compute_dispatch(builder, &
                                       ...
                                       user_data)
    type(pm4_packet_builder), intent(inout) :: builder
    integer(int64), intent(in) :: shader_addr
    integer, intent(in) :: threads_x, threads_y, threads_z
    integer, intent(in) :: grid_x, grid_y, grid_z
    integer(int32), intent(in), optional :: user_data(:)
    
    integer(int32) :: pgm_rsrc1, pgm_rsrc2
    integer :: i
...
end module sparkle_pm4_packets