module sparkle_pm4_compute
  ...
  type :: pm4_compute_context
    ...
    integer(int32) :: ctx_id = 0
    integer(int32) :: bo_list_id = 0
    logical :: initialized = .false.
    
    ! Shader cache
    integer :: num_shaders = 0
    integer(int64), allocatable :: shader_addresses(:)
...
contains
  ...
  subroutine pm4_add_shader(this, name, addr)
    ...
    integer(int64), allocatable :: new_addrs(:)
  ...
  function pm4_execute_compute(shader_addr, &
    ...
    integer(int32), allocatable :: cmd_data(:)
    integer :: status, cmd_size
    integer(int32) :: user_data(16)
    integer :: i
...
end module sparkle_pm4_compute