...
contains
  ...
  function plan_shards(mesh, work_size, work_type) result(choice)
    ...
    integer(int64), intent(in) :: work_size  ! Total work (e.g., matrix elements)
  ...
  subroutine explain_schedule(mesh, choice)
    ...
    print *, "=== Sparkle Schedule Explanation ==="
